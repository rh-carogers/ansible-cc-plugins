...
| ansible-jira-expert | Jira specialist agent for searching, managing, and analyzing issues          | 1.1.1   |
| daily-brief         | Daily briefing dashboard from calendar, email, Slack, Jira, and community sources | 1.0.0   |
